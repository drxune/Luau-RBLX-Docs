...
Source: https://create.roblox.com/docs/reference/engine/classes/StarterGear
Scraped: 2026-01-11T02:37:27.030599Z
...
6. /
7. [StarterGear](/docs/reference/engine/classes/StarterGear)
...
player's StarterGear will get copied into the player's [Backpack](/docs/reference/engine/classes/Backpack).
...
[Player](/docs/reference/engine/classes/Player) when the player joins the game. When a player spawns, the
contents of that player's StarterGear is copied into the player's
[Backpack](/docs/reference/engine/classes/Backpack). Additionally, when a player connects to a game that permits
gear, all of the appropriate gear [Tool](/docs/reference/engine/classes/Tool) objects that the player owns
are inserted into that player's StarterGear.

Unlike [StarterPack](/docs/reference/engine/classes/StarterPack), StarterGear is not a service but rather a child of
each [Player](/docs/reference/engine/classes/Player) object -- this means that its contents are player-specific
so that each player can have different [Tools](/docs/reference/engine/classes/Tool) within their
[StarterGear](/docs/reference/engine/classes/StarterGear). It is not replicated to any client, including the owning
player.

Accessing StarterGear
---------------------

Listening to the [Players.PlayerAdded](/docs/reference/engine/classes/Players#PlayerAdded) event is useful for
...
includes [Scripts](/docs/reference/engine/classes/Script) and allows the player to perform actions that
