# ProximityPromptStyle | Documentation - Roblox Creator Hub

Source: https://create.roblox.com/docs/reference/engine/enums/ProximityPromptStyle
Scraped: 2026-01-11T02:46:55.447679Z

## Inherits
- ProximityPrompt.Style
1. [Enums](/docs/reference/engine/enums)
2. /
3. [ProximityPromptStyle](/docs/reference/engine/enums/ProximityPromptStyle)
...
| Name | Value | Summary |
| --- | --- | --- |
| Default | 0 | The default prompt UI style. |
| Custom | 1 | Custom prompt UI style as set by the developer. For more information, see [ProximityPrompt.Style](/docs/reference/engine/classes/ProximityPrompt#Style). |
